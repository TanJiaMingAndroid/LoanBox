...
public class InsteadPresenter implements InsteadContract.Presenter {

    private Context mContext;
    private InsteadContract.View mView;

    private ApiService mApiService;

    public InsteadPresenter(Context context, InsteadContract.View view) {
