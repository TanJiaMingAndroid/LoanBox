...
import com.ps.eachgold.presenter.RepayCardPresenter;
import com.ps.eachgold.util.DpPxUtil;
import com.ps.eachgold.util.SPutils;
import com.ps.eachgold.viewHold.RepayCardViewHolder;
...
public class  RepayCardActivity extends BaseActivity implements RepayCardContract.View, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnMoreListener {
    ...
    public void initRecycler() {
        ...
        recyclerRepayCard.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<LoanBean>(this) {
            @Override
