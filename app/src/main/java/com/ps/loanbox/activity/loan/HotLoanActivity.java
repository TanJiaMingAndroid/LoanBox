...
import com.ps.loanbox.contract.main.LoanContract;
import com.ps.loanbox.presenter.LoanPresenter;
...
public class HotLoanActivity extends BaseActivity implements LoanContract.View, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnMoreListener {
    ...
    public void initRecycler() {
        ...
        recyclerHotLoan.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<ProductBean>(this) {
            @Override
