...
import com.ps.loanbox.contract.loan.LoanListContract;
import com.ps.loanbox.presenter.LoanListPresenter;
import com.ps.loanbox.util.DpPxUtil;
import com.ps.loanbox.util.SPutils;
import com.ps.loanbox.viewHold.LoanListViewHolder;
...
public class LoanListActivity extends BaseActivity implements LoanListContract.View, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnMoreListener {
    ...
    public void initRecycler() {
        ...
        recycleLoan.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<ProductBean>(this) {
            @Override
