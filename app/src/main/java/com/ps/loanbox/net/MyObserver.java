...
import com.ps.loanbox.bean.BaseBean;
import com.ps.loanbox.contract.ImpBaseView;
import com.ps.loanbox.util.L;
...
public abstract class MyObserver<T> implements Observer<BaseBean<T>> {
    ...
    public MyObserver(Context mContext,ImpBaseView impBaseView) {
     ...
     *
     */
    public MyObserver(Context mContext, ImpBaseView impBaseView, String message) {
        this.mContext = mContext;
        this.impBaseView = impBaseView;
    ...
    @Override
    public final void onNext(BaseBean<T> response) {
        mDisposable.dispose();
        if (impBaseView != null) {
